...
class InitCardRepositoryImpl implements InitCardRepository {
  ...
  Future<Either<Failure, String>> initCard({
    ...
    try {
      if (!await initCardLocalDatasource.checkInternetConnection()) {
      ...
      final response = await initCardLocalDatasource.initCardMode(
        cardModeDetails: InitCardModel(
      ...
      return Left(Failure(message: "Exception in Initilization."));
    }
  }
}
